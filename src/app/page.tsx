          ...
          >
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-0.5">
                          ...
                          <span className="text-[10px] text-white/70">
                            ⏱ 1–2 минуты · 🪫 низкая энергия · 🥨 закуска
                          </span>
                        </div>
                      </button>
                    </li>
                    <li>
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-0.5">
                          ...
                          <span className="text-[10px] text-white/70">
                            ⏱ 1 минута · 🪫 низкая энергия · 🥨 закуска
                          </span>
                        </div>
                      </button>
                    </li>
                    <li>
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-0.5">
                          ...
                          <span className="text-[10px] text-white/70">
                            ⏱ 3–5 минут · 🪫 низкая энергия · 🥨 закуска
                          </span>
                        </div>
                      </button>
                    </li>
                    <li>
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-0.5">
                          ...
                          <span className="text-[10px] text-white/70">
                            ⏱ 5–10 минут · 🪫 низкая энергия · 🥨 закуска
                          </span>
                        </div>
                      </button>
                    </li>
                ...
                <ul className="mt-2 space-y-1 border-t border-white/10 pt-2 text-white/90">
                  ...
                  <li>
                    <button
                      type="button"
                      className="flex w-full items-start gap-2 rounded-xl bg-white/5 px-2 py-1.5 text-left hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400/70"
                      onClick={() => setSelectedAction("Контрастные ощущения (тепло / холод)")}
                    >
                      <span className="mt-0.5 text-emerald-300">✔</span>
                      <div className="flex flex-col gap-0.5">
              ...
              <div className="flex flex-col gap-1.5 rounded-2xl bg-white/5 p-3 text-[11px] sm:text-xs md:text-sm">
                ...
                <p className="mt-1 text-[10px] text-white/60">
                  Помогает вернуть интерес, но не отменяет усталость и выгорание.
                </p>
                <ul className="mt-2 space-y-1 border-t border-white/10 pt-2 text-white/90">
                  <li>
                    <button
                  ...
                  <li>
                    <button
                      type="button"
                      className="flex w-full items-start gap-2 rounded-xl bg-white/5 px-2 py-1.5 text-left hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400/70"
                      onClick={() => setSelectedAction("Создание чего-то «без цели»")}
                    >
                      <span className="mt-0.5 text-emerald-300">✔</span>
                      <div className="flex flex-col gap-0.5">
              ...
              <div className="flex flex-col gap-1.5 rounded-2xl bg-white/5 p-3 text-[11px] sm:text-xs md:text-sm">
                ...
                <p className="mt-1 text-[10px] text-white/60">
                  Помогает почувствовать контроль, но не обязан превращаться в марафон продуктивности.
                </p>
                <ul className="mt-2 space-y-1 border-t border-white/10 pt-2 text-white/90">
                  <li>
                    <button
                ...
                <ul className="mt-2 space-y-1 border-t border-white/10 pt-2 text-white/90">
                  ...
                  <li>
                    <button
                      type="button"
                      className="flex w-full items-start gap-2 rounded-xl bg-white/5 px-2 py-1.5 text-left hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400/70"
                      onClick={() => setSelectedAction("Поддержка / благодарность")}
                    >
                      <span className="mt-0.5 text-emerald-300">✔</span>
                      <div className="flex flex-col gap-0.5">
